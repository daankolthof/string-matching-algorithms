...
int RabinKarp::findString(const std::string& string, const std::string& pattern)
{
...
int RabinKarp::calculateHash(const std::string& string)
{
	int result_hash = 0;
...
int RabinKarp::calculateRollingHash(const uint8_t previous_hash, const char old_char, const char new_char, const uint8_t offset_left_char)
{
